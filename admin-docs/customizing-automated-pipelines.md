...
([GitHub link](https://github.com/CouncilDataProject/pittsburgh-pa/tree/main/.github)),
and then to the `workflows` sub-directory
([GitHub link](https://github.com/CouncilDataProject/pittsburgh-pa/tree/main/.github/workflows)).
...
([GitHub link](https://github.com/CouncilDataProject/pittsburgh-pa/tree/main/.github/workflows/event-gather-pipeline.yml)).
...
([GitHub link](https://github.com/CouncilDataProject/pittsburgh-pa/tree/main/.github/workflows/event-index-pipeline.yml)).
